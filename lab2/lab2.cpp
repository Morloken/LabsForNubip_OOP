...
public:
    //b) Конструктор без параметрів (ініціалізація значеннями 0)
    Hourglass() : a(0), b(0) {}
    ...
    //c) обчислення площі (основа годинника - трикутники)
    ...
    //e) Дружня функція для додавання розмірів двох екземплярів
    friend Hourglass frd(const Hourglass& h1, const Hourglass& h2);
};

//e) Ініціалізація Дружьої функції для додавання сторін двох екземплярів
...
int main() {
    ...
    Hourglass hg2(2.0, 5.0); // Другий екз

    //інфо про перший годинник
    cout << "\n------------------" << endl;
    cout << "Перший пісочний годинник:" << endl;
    hg1.print_sqrt();

    // інфо про 2гий годинник
    cout << "\n------------------" << endl;
