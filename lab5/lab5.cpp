...
ostream& operator<<(ostream& os, const Romb& r) {// і уже запис дій у дружню функцію що створив раніше
    os << "Romb{a=" << r.a << ",b=" << r.b << "}";
    return os;
}
...
int main() {
    ...
    COUT << "Виведення адрес та значень об'єктів "<<ENDL;
    COUT << "------------------- " << ENDL;
    COUT << &romb1 << "\t" << romb1 << ENDL;
    COUT << &romb2 << "\t" << romb2 << ENDL;
    COUT << &romb3 << "\t" << romb3 << ENDL << ENDL;
    ...
    COUT << " Додавання ромбів та виведення результату " << ENDL;
    COUT << "------------------- " << ENDL;
    COUT << romb1 + romb2 << ENDL;

    // Виведення об'єктів після додавання
    COUT << "Виведення об'єктів після додавання" << ENDL;
    COUT << "------------------- " << ENDL;
    COUT << &romb1 << "\t" << romb1 << ENDL;
    COUT << &romb2 << "\t" << romb2 << ENDL << ENDL;

    // Інкрементування об'єктів
    COUT << "Інкрементування об'єктів" << ENDL;
    COUT << "------------------- " << ENDL;
    romb1++;
    romb2++;
    COUT << &romb1 << "\t" << romb1 << ENDL;
    ...
    COUT << "Декрементування об'єктів" << ENDL;
    COUT << "------------------- " << ENDL;
    romb1--;
    romb2--;
    COUT << &romb1 << "\t" << romb1 << ENDL;
    ...
    COUT << "Присвоєння об'єктів після декременту" << ENDL;
    COUT << "------------------- " << ENDL;
    romb1 = romb2;
    COUT << &romb1 << "\t" << romb1 << ENDL;
    COUT << &romb2 << "\t" << romb2 << ENDL << ENDL;
