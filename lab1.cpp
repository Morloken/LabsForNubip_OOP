...
public:
  ...
  Rhombus(double a_val, double b_val) : a(a_val), b(b_val) {
    cout << "Ромб створений з діагоналями a: " << a << ", b: " << b << "."
         << endl;
  }

  ~Rhombus() { // destructor
    cout << "Ромб з діагоналями a: " << a << " і b: " << b << " знищено."
         << endl;
  }
  ...
  double getA() const { return a; } // method that doesnt change the value

  double getB() const { return b; } // method that doesnt change the value
